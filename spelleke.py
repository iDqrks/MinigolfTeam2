...
class Level:
    def __init__(self, hole_pos, obstacles, par, start_pos=(50, 50)):
...
levels = [
    ...
    Level(
        ...
        obstacles=[
            ...
            pygame.Rect(200, 350, 400, 20),
            pygame.Rect(300, 250, 20, 100)
        ],
        par=4,
        start_pos=(50, 50)
    ),
    ...
    Level(
        ...
        obstacles=[
            ...
            pygame.Rect(150, 350, 500, 20),
            pygame.Rect(150, 150, 20, 220),
            pygame.Rect(630, 150, 20, 220)
        ],
        par=6,
        start_pos=(50, 50)
    ),
